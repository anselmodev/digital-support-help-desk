	...
	<main class="container-fluid main-content">
		...
		<header class="home-header">
			<div id="search-alert" class="alert alert-warning alert-search"
				role="alert">Nenhum Resultado Encontrado!</div>
			<!-- logo -->
			<div class="home-logo">
							...
							<form class="modal-form">
								...
								<div class="form-group pass-user">
									...
									<input type="password" class="form-control" id="userPass"
										...
										id="show-hide-pass"> <i data-feather="eye" width="35"
										color="#A358BC" id="eye-show"></i> <i data-feather="eye-off"
